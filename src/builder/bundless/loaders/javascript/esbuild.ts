...
import { build } from '../../../../../compiled/esbuild';
import { FastscBundlessConfig, PlatformTypes } from '../../../../types';
 ...
 */
function createAliasReplacer(opts: { alias: FastscBundlessConfig['alias'] }) {
...
const esbuildTransformer: IJSTransformer = async function () {
  ...
  const {
    ...
    target: this.config.platform === PlatformTypes.NODE ? 'node14' : 'es6',
